...
let posterize_levels_amount = getRandomInt(2, 4);
let dither_pixel_size = getRandomInt(1, 4);
let solarize_threshold_amount = 128;
let emboss_pixel_size_amount = getRandomInt(1, 4);
let edge_pixel_size_amount = getRandomInt(1, 4);
let pixelate_amount = getRandomInt(2, 8);
let glitch_pixel_size = getRandomInt(2, 20);
let glitch_amount = getRandomInt(2, 16);
...
let wave_amplitude = getRandomInt(2, 20);
